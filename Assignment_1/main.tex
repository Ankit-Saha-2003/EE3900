...
\begin{document}
	...
	From the plot, it is clear that the magnitude of the discrete-time Fourier transform of $x(n)$ is symmetric about $x = 0$ and is periodic with a period of $2\pi$. 
	
	Also, it attains a maximum value of $4$ at $$x = (2n + 1)\pi, \quad n \in \mathbb{Z}$$ and a minimum of $0$ at $$x = \brak{2m + 1}\frac{\pi}{2}, \quad m \in \mathbb{Z}\quad $$
